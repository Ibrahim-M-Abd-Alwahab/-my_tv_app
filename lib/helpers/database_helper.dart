...
// created_at: the time that the item was created. It will be automatically handled by SQLite
  // Create new item
  static Future<int> createItem(String? name, String? link) async {
    final db = await DatabaseHelper.db();

    final data = {'name': name, 'link': link};
  ...
  static Future<int> updateItem(int id, String name, String? link) async {
    final db = await DatabaseHelper.db();
