...
import 'package:my_tv_app/Modules/Channels/singel_categ_streaming.dart';
...
class HomeChannelsStremingScreen extends ConsumerStatefulWidget {
  String action;
  static const roudName = "/HomeChannelsStremingScreen";

  HomeChannelsStremingScreen(
    this.action,
  );

  @override
  _HomeChannelsStremingScreenState createState() =>
      _HomeChannelsStremingScreenState();
}

class _HomeChannelsStremingScreenState
    extends ConsumerState<HomeChannelsStremingScreen> {
          ...
          builder: (context, ref, child) => FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                var dataList =
                    ref.watch(accountProvider).getStreamingModelList ?? [];
